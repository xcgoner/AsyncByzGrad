...
# start training
python /homes/cx2/zeno_async/zeno_async/train_cifar10.py --classes 10 --model cifar_resnet20_v1 --batchsize 128 --lr 0.1 --lr-decay 0.1 --lr-decay-epoch 100,150 --epochs 200 --seed 337 --max-delay 5 --dir $inputdir --log $logfile 2>&1 | tee $watchfile
